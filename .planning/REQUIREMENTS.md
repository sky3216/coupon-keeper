...
- [x] **PRO-03**: User can purchase Pro through App Store or Google Play in-app purchase.
- [x] **PRO-04**: User can restore Pro purchase.
...
- [x] **QUAL-01**: App works without account login, server sync, or cloud backup.
- [x] **QUAL-02**: App does not send photos, coupon images, OCR text, or location data off-device.
- [x] **QUAL-03**: App exposes loading, empty, error, success, and partial-success UI states for Today, Scan, Wallet, Pass Detail, Pro Gate, and Cleanup.
...
| PRO-03 | Phase 6 | Complete |
| PRO-04 | Phase 6 | Complete |
